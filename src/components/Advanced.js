...
export default function Advanced() {
  return (
    <>
      <section className="bg-gray-100 pt-10 lg:py-20 lg:pb-40">
        <div className="max-width">
          ...
          <div className=" relative card grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
            ...
            <article className="bg-white p-5 rounded relative">
              ...
              <p className="text-slate-400 text-sm">
                Gain insights into who is clicking your l className="bg-white
                p-5 rounded"inks. Knowing when and where people engage with your
            ...
            <article className="bg-white p-5 rounded relative">
              <img
                ...
                className="p-3 -mt-12 bg-slate-800 rounded-full"
              />
              <h3 className="text-slate-800 text-lg mb-2 font-bold">
                Fully Customizable
              </h3>
              <p className="text-slate-400 text-sm">
